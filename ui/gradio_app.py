...
def run_search(job_title, country, user_skills, work_mode, no_results, language, score_th):
    ...
    try:
        ...
        yield _progress("Done.")
        yield render_job_cards(jobs, "No job results found.")
    ...
    with gr.Blocks(css=CUSTOM_CSS, title="AI Agent Job Search") as demo:
        ...
        with gr.Row():
            ...
            with gr.Column(scale=2):
                ...
                jobs_html = gr.HTML(
                    value='<div class="no-results">Run a search to see job results.</div>'
                )
